...
%     
%     FF = [p(i);
%           fy1(i) + fy2(i) - (m + mf + mr) * u * r(i);
%           a*fy1(i) - b*fy2(i) - (a*mf - b*mr) * u * r(i);
...
%drll,dv,dp,dr
    ...
    FF = [p(i);
          (fy1(i)*cos(delta(i)) + fy2(i))*sign(u) - m * u * r(i);
          (a*fy1(i)*cos(delta(i)) - b*fy2(i))*sign(u) ;
          (Crll * p(i) + Krll * rll(i)) - m * hb *u*r(i)];
